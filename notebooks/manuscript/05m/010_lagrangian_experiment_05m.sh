#!/bin/bash
#SBATCH --job-name=north-sea_oysters_lagrangian_experiment_manuscript_05m
#SBATCH --ntasks=100
...
for year in 2019 2020 2021 2022; do
    ...
    for start_date_offset_days in {0..121}; do #mid May till mid September
        ...
        && papermill --cwd notebooks/manuscript/05m \
            notebooks/manuscript/05m/010_lagrangian_experiment_05m.ipynb \
